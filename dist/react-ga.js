...
var internalGa = function internalGa() {
  ...
  if (_testMode) return _testModeAPI["default"].gtag.apply(_testModeAPI["default"], arguments);
  if (_isNotBrowser) return false;
  if (!window.gtag) return (0, _warn["default"])('ReactGA.initialize must be called first or GoogleAnalytics should be loaded manually');
...
function _gtagCommand(trackerNames) {
  ...
  if (typeof internalGa === 'function') {
    if (typeof command !== 'string') {
      (0, _warn["default"])('gtag command must be a string');
      return;
    }
...
function _initialize(gtagTrackingID, options) {
  if (!gtagTrackingID) {
    (0, _warn["default"])('gtagTrackingID is required in initialize()');
    return;
  }
...
function gtag() {
  ...
  if (args.length > 0) {
    ...
    if (_debug) {
      (0, _log["default"])("called gtag('arguments');");
...
function set(fieldsObject, trackerNames) {
  ...
  if (_debug) {
    (0, _log["default"])("called gtag('set', fieldsObject);");
...
function send(fieldObject, trackerNames) {
  ...
  if (_debug) {
    (0, _log["default"])("called gtag('send', fieldObject);");
...
function pageview(rawPath, trackerNames, title) {
  ...
  if (typeof gtag === 'function') {
    _gtagCommand(trackerNames, 'send', _objectSpread({
      hitType: 'pageview',
      page: path
    }, extraFields));

    if (_debug) {
      (0, _log["default"])("called gtag('send', 'pageview', path);");
      var extraLog = '';
  ...
  require: function require(rawName, options, trackerName) {
    if (typeof gtag === 'function') {
      ...
      if (options) {
        ...
        if (_debug) {
          (0, _log["default"])("called gtag('require', '".concat(name, "', ").concat(JSON.stringify(options)));
        }
      } else {
        gtag(requireString, name);

        if (_debug) {
          (0, _log["default"])("called gtag('require', '".concat(name, "');"));
        }
      }
    }
  },
    ...
    if (typeof gtag === 'function') {
      if (typeof pluginName !== 'string') {
        ...
        if (actionType && payload) {
          ...
          if (_debug) {
            (0, _log["default"])("called gtag('".concat(command, "');"));
...
exports["default"] = exports.OutboundLink = exports.testModeAPI = exports.outboundLink = exports.plugin = exports.exception = exports.event = exports.timing = exports.modalview = exports.pageview = exports.send = exports.set = exports.gtag = exports.addTrackers = exports.initialize = void 0;
